...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="container bg-success" style=""width: fit-content">
        ...
        <asp:TextBox CssClass="form" ID="txtCalificacion" runat="server" ReadOnly="False"></asp:TextBox>
        <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="El rango ingresado de calificación no es valido. Válidos: 0-100" Type="Double" MaximumValue="100" MinimumValue="0" ValidationGroup="1" ControlToValidate="txtCalificacion" ForeColor="Red">*</asp:RangeValidator>
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Debe ingresar Califcación" ControlToValidate="txtCalificacion" ValidationGroup="1" ForeColor="Red">*</asp:RequiredFieldValidator>
