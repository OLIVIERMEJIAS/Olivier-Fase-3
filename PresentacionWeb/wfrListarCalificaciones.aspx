<%@ Page Title="" Language="C#" MasterPageFile="~/wfrPlantilla.Master" AutoEventWireup="true" CodeBehind="wfrListarCalificaciones.aspx.cs" Inherits="PresentacionWeb.wfrListarCalificaciones" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="container">
        <div class="card-header text-center">   
            <h1 class="bg-success">Gestión de Calificaciones</h1>
        </div>
    </div>
    <br />
    ...
    <div class="container">
        <asp:GridView ID="gdvEstudiantes" runat="server" AutoGenerateColumns="False" BackColor="White" BorderColor="#999999" BorderStyle="None" BorderWidth="1px" CellPadding="3" GridLines="Vertical" Width="100%">
            ...
            <Columns>
                ...
                <asp:TemplateField>
                    <ItemTemplate>
                        <asp:LinkButton ID="lnkAsignar" runat="server" CommandArgument='<%# Eval("estudianteId").ToString() %>' ForeColor="#0099CC" OnCommand="lnkAsignar_Command">Asignar Calificación</asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
